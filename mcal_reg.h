...
namespace mcal
{
  namespace reg
  {
    ...
    struct reg_access_dynamic final
    {
      ...
      {
        *reinterpret_cast<volatile RegisterValueType*>(address) |= static_cast<RegisterValueType>(1ULL << bit_pos);
      }
    ...
    struct reg_access_static final
    {
      ...
      static void bit_set()
      {
        *reinterpret_cast<volatile RegisterValueType*>(address) |= static_cast<RegisterValueType>(1ULL << value);
      }
